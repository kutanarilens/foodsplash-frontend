  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: const [
          _StatusTabs(selected: OrderStatus.diproses),
          SizedBox(height: 16),
          _OrderCard(),
        ],
      ),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // BARIS ATAS: rating + nama toko + status
            Row(
              children: [
                Container(
                  padding:
                  ...
                  child: Row(
                    children: const [
                      Icon(Icons.star,
                          size: 12, color: Color(0xFF33B8E8)),
                      SizedBox(width: 4),
                      Text(
                        '4.4',
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0x99CDF6F1),
                borderRadius: BorderRadius.circular(8),
                border: Border.all(color: const Color(0xFFCEF7F1)),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: const [
                  ...
                  SizedBox(height: 2),
                  Text(
                    'Makananmu sedang disiapkan oleh penjual',
                    style: TextStyle(
                      fontSize: 9,
                      color: Colors.black54,
                    ),
